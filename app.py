...
if file is not None:  #se il file non è vuoto fai le instruzioni che arrivano dopo
    ...
    if domanda:       #se domanda c'è allora fai cose
        st.write("Sto cercado le informazioni che mi hai richiesto...")
        rilevanti = vector_store.similarity_search(domanda) #in questo contenitore metto i pezzetti pdf che sono rilevati, che hanno superato il test di somiglianza 
        # st.write
